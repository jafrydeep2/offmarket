...
import { ArrowLeft, Send, Video, Camera, Play, Award, CheckCircle, Star, Users, Home, MapPin, DollarSign, MessageSquare } from 'lucide-react';
...
export const PropertyVideosPage: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.success(t('propertyVideos.form.success'));
            setFormData({
                firstName: '',
                lastName: '',
                email: '',
            ...
            toast.error(t('propertyVideos.form.error'));
        } finally {
                ...
                <div className="container-custom">
                    ...
                    >
                        <h2 className="text-3xl md:text-4xl font-heading font-bold text-foreground">
                            {t('propertyVideos.process.title')}
                        </h2>
                        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                            {t('propertyVideos.process.subtitle')}
                        </p>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        >
                            ...
                            <p className="text-sm text-muted-foreground">
                                {t('propertyVideos.process.production.description')}
                            </p>
                        </motion.div>
                        <motion.div
                            initial={{ opacity: 0, y: 30 }}
                        ...
                        >
                            ...
                            <p className="text-sm text-muted-foreground">
                                {t('propertyVideos.process.editing.description')}
                            </p>
                        </motion.div>
                        <motion.div
                            initial={{ opacity: 0, y: 30 }}
                        ...
                        >
                            ...
                            <p className="text-sm text-muted-foreground">
                                {t('propertyVideos.process.delivery.description')}
                            </p>
                        </motion.div>
                    </div>
                </div>
                ...
                <div className="container-custom">
                    ...
                    >
                        <h2 className="text-3xl md:text-4xl font-heading font-bold text-foreground mb-8">
                            {t('propertyVideos.description.title')}
                        </h2>
                        <p className="text-lg md:text-xl leading-relaxed text-muted-foreground mb-12">
                            {t('propertyVideos.description.content')}
                        </p>

                        {/* Benefits Grid */}
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {[
                                { icon: Camera, text: t('propertyVideos.benefits.professional') },
                                { icon: Play, text: t('propertyVideos.benefits.engaging') },
                                { icon: Users, text: t('propertyVideos.benefits.attraction') },
                                { icon: Home, text: t('propertyVideos.benefits.showcase') }
                            ].map((benefit, index) => (
                                <motion.div
                                    key={index}
                ...
                <div className="container-custom relative">
                    ...
                    >
                        <Card className="shadow-2xl border-0 bg-card/80 backdrop-blur-sm overflow-hidden">
                            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue-500 via-blue-500/80 to-blue-500" />
                            ...
                            <CardHeader className="text-center py-12 px-8">
                                ...
                                >
                                    <CardTitle className="text-3xl md:text-4xl font-heading font-bold text-foreground mb-4">
                                        {t('propertyVideos.form.title')}
                                    </CardTitle>
                                    <p className="text-muted-foreground text-lg">
                                        {t('propertyVideos.form.subtitle')}
                                    </p>
                                </motion.div>
                            </CardHeader>
                                ...
                                >
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div className="space-y-3">
                                            <Label htmlFor="firstName" className="text-sm font-semibold text-foreground flex items-center">
                                                {t('propertyVideos.form.firstName')}
                                            ...
                                            <Input
                                                ...
                                                required
                                                className="h-14 text-lg border-2 transition-all duration-300 focus:border-blue-500 focus:shadow-lg focus:shadow-blue-500/20"
                                            />
                                        </div>
                                        ...
                                        <div className="space-y-3">
                                            <Label htmlFor="lastName" className="text-sm font-semibold text-foreground flex items-center">
                                                {t('propertyVideos.form.lastName')}
                                                <span className="text-destructive ml-1">*</span>
                                            </Label>
                                            <Input
                                                id="lastName"
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div className="space-y-3">
                                            <Label htmlFor="propertyType" className="text-sm font-semibold text-foreground flex items-center">
                                                {t('propertyVideos.form.propertyType')}
                                                <span className="text-destructive ml-1">*</span>
                                            </Label>
                                            <Select value={formData.propertyType} onValueChange={(value) => handleInputChange('propertyType', value)} required>
                                                <SelectTrigger className="h-14 text-lg border-2 transition-all duration-300 focus:border-blue-500 focus:shadow-lg focus:shadow-blue-500/20">
                                                    <SelectValue placeholder={t('propertyVideos.form.propertyType')} />
                                                </SelectTrigger>
                                                <SelectContent className="bg-background border-2 shadow-xl">
                                                    <SelectItem value="apartment" className="text-lg py-3">
                                                        {t('propertyVideos.form.propertyTypes.apartment')}
                                                    </SelectItem>
                                                    <SelectItem value="house" className="text-lg py-3">
                                                        {t('propertyVideos.form.propertyTypes.house')}
                                                    </SelectItem>
                                                    <SelectItem value="villa" className="text-lg py-3">
                                                        {t('propertyVideos.form.propertyTypes.villa')}
                                                    </SelectItem>
                                                    <SelectItem value="penthouse" className="text-lg py-3">
                                                        {t('propertyVideos.form.propertyTypes.penthouse')}
                                                    </SelectItem>
                                                </SelectContent>
                                            </Select>
                                        </div>
                                        ...
                                        <div className="space-y-3">
                                            <Label htmlFor="location" className="text-sm font-semibold text-foreground flex items-center">
                                                {t('propertyVideos.form.location')}
                                                <span className="text-destructive ml-1">*</span>
                                            </Label>
                                            <Input
                                                id="location"
                                                ...
                                                placeholder={t('propertyVideos.form.locationPlaceholder')}
                                                required
                                                className="h-14 text-lg border-2 transition-all duration-300 focus:border-blue-500 focus:shadow-lg focus:shadow-blue-500/20"
                                            />
                                        </div>
                                    ...
                                    <div className="space-y-3">
                                        <Label htmlFor="message" className="text-sm font-semibold text-foreground flex items-center">
                                            {t('propertyVideos.form.message')}
                                        </Label>
                                        <Textarea
                                            id="message"
                                            value={formData.message}
                                            onChange={(e) => handleInputChange('message', e.target.value)}
                                            placeholder={t('propertyVideos.form.messagePlaceholder')}
                                            className="min-h-[120px] text-lg border-2 transition-all duration-300 focus:border-blue-500 focus:shadow-lg focus:shadow-blue-500/20"
                                        />
                                    </div>
                                        ...
                                        >
                                            {isSubmitting ? (
                                                ...
                                                >
                                                    ...
                                                    <span>{t('propertyVideos.form.submit')}</span>
                                                </motion.div>
                                            )}
                                        </Button>
                                    </div>
